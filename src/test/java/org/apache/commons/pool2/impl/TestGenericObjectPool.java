...
public class TestGenericObjectPool extends TestBaseObjectPool {
    ...
    public void testJmxRegistration() {
        ...
        try {
            assertEquals(new ObjectName("org.apache.commons.pool2:type=GenericObjectPool,name=pool"), poolWithDefaultJmxNameBase.getJmxName());
        } catch (MalformedObjectNameException e) {
            fail("Failed to create JMX object name: " + e.getMessage());
        }
    }
